...
float calcular(float num1_a, float num2_a, char operador){
    
    float resultado = -99999;
    ...
    printf("->>>> OPERAÇÃO REALIZADA: %f %c %f = %f;;;", num1_a, operador, num2_a, resultado);
...
cb_status op1_inteiro_cb(event_t ev){
    ...
    switch(ev){
        ...
        case EVENT_NUMERO:
            ...
            printf("op1_inteiro-NUMERO; Num1 atual: %c %f", (num1_sinal==-1)?'-':' ',num1);
            return EVENT_HANDLED;
        case EVENT_PONTO:
        ...
        case EVENT_SINAL:
            num1_sinal *= -1;
            printf("op1_inteiro-SINAL; NUM1 : %c %f;", (num1_sinal==-1)?'-':' ',num1);
            return EVENT_HANDLED;
...
cb_status op2_inteiro_cb (event_t ev){
    ...
    switch(ev){
        ...
        case EVENT_NUMERO:
            ...
            printf("op2_inteiro-NUMERO; Num2 atual: %c %f", (num2_sinal==-1)?'-':' ',num2);
        ...
        case EVENT_SINAL:
            num2_sinal *= -1;
            printf("op2_inteiro-SINAL; NUM2 : %c %f;", (num2_sinal==-1)?'-':' ',num2);
            return EVENT_HANDLED;
